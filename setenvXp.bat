...
rem set _NT_TOOLS_VERSION=0x700
...
:usage
echo.
echo Usage: "setenv <directory> [fre|chk] [64|x64] [WIN7|WLH|WXP|WNET] [bscmake] [no_oacr] [separate_object_root]"
echo.
